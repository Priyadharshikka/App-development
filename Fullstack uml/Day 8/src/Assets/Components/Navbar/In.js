...
const Inventory = () => {
  ...
  const fetchInventoryData = async () => {
    try {
      const response = await axios.get('/api/inventory'); // Assuming your API endpoint is '/api/inventory'
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('/api/inventory', formData); // Assuming your API endpoint for adding inventory is '/api/inventory'
  ...
  const handleUpdate = async (itemId) => {
    ...
    try {
      const response = await axios.put(`/api/inventory/${itemId}`, itemToUpdate); // Assuming your API endpoint for updating inventory is '/api/inventory/:itemId'
      if (response.status === 200) {
        fetchInventoryData();
  ...
  const handleDelete = async (itemId) => {
    try {
      const response = await axios.delete(`/api/inventory/${itemId}`); // Assuming your API endpoint for deleting inventory is '/api/inventory/:itemId'
      if (response.status === 200) {
